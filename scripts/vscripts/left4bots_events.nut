						...
						if (arg2 in Settings) {
							if (!arg3)
								...
								try {
									...
									SettingsTmp <- {};
									Left4Utils.LoadSettingsFromFileNew("cfg/settings.txt", "::Left4Bots.SettingsTmp.", Logger, true);
									SettingsTmp[arg2] <- Settings[arg2];
									Left4Utils.SaveSettingsToFileNew("cfg/settings.txt", SettingsTmp, Logger);
